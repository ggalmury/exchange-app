import { currencyTranslate } from '@/features/exchange-rate/constants/currency';
...
const ExchangeRateCard = ({ exchangeRate }: ExchangeRateCardProps) => {
  ...
  return (
    <div className="flex min-h-35.75 min-w-76 flex-col justify-between rounded-xl border border-gray-300 bg-white p-6">
      <div className="flex items-center justify-between text-gray-600">
        <p className="text-xl font-semibold">{currency}</p>
        <p className="text-base">{currencyTranslate[currency]}</p>
      </div>
